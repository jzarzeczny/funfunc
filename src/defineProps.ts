...
function __VLS_template() {
  ...
  /* Style Scoped */
  type __VLS_StyleScopedClasses = {} & { header?: boolean } & { button?: boolean }
  ...
  {
    let __VLS_10!: 'RouterView' extends keyof typeof __VLS_ctx
      ? typeof __VLS_ctx.RouterView
      : (typeof __VLS_resolvedLocalAndGlobalComponents)['RouterView']
